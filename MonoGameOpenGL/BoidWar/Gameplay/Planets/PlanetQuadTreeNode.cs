...
namespace MonoGameEngineCore.Procedural
{
    ...
    public class PlanetNode : GameObject.GameObject
    {
        ...
        public StaticMeshColliderComponent meshCollider;
        ...
        public void BuildGeometry()
        {
            ...
            meshCollider = new StaticMeshColliderComponent(this, spherePatch.GetVertices(), spherePatch.GetIndicesAsInt().ToArray(), Vector3.Zero);
        ...
        private void AdjustEdgesUpOneLOD(ref VertexPositionColorTextureNormal[] vertices, ref List<int> edgeIndexes, Color color)
        {
            for (int i = 1; i < edgeIndexes.Count - 1; i += 2)
            {
                ...
                if (SystemWarGlobalSettings.VisualisePatches)
