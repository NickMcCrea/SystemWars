...
namespace Kaitai
{
    public partial class DoomWad : KaitaiStruct
    {
        ...
        public partial class Sectors : KaitaiStruct
        {
            ...
            public Sectors(KaitaiStream io, IndexEntry parent = null, DoomWad root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
        ...
        public partial class Vertex : KaitaiStruct
        {
            ...
            public Vertex(KaitaiStream io, Vertexes parent = null, DoomWad root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
        ...
        public partial class Linedef : KaitaiStruct
        {
            ...
            public Linedef(KaitaiStream io, Linedefs parent = null, DoomWad root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
        ...
        public partial class Sector : KaitaiStruct
        {
            ...
            public Sector(KaitaiStream io, Sectors parent = null, DoomWad root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
        ...
        public partial class Vertexes : KaitaiStruct
        {
            ...
            public Vertexes(KaitaiStream io, IndexEntry parent = null, DoomWad root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
        ...
        public partial class Sidedef : KaitaiStruct
        {
            ...
            public Sidedef(KaitaiStream io, Sidedefs parent = null, DoomWad root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
        ...
        public partial class Things : KaitaiStruct
        {
            ...
            public Things(KaitaiStream io, IndexEntry parent = null, DoomWad root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
        ...
        public partial class Linedefs : KaitaiStruct
        {
            ...
            public Linedefs(KaitaiStream io, IndexEntry parent = null, DoomWad root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
        ...
        public partial class Sidedefs : KaitaiStruct
        {
            ...
            public Sidedefs(KaitaiStream io, IndexEntry parent = null, DoomWad root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
        ...
        public partial class Blockmap : KaitaiStruct
        {
            ...
            public Blockmap(KaitaiStream io, IndexEntry parent = null, DoomWad root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
            ...
            public partial class Blocklist : KaitaiStruct
            {
                ...
                public Blocklist(KaitaiStream io, Blockmap parent = null, DoomWad root = null) : base(io)
                {
                    m_parent = parent;
                    m_root = root;
                    _parse();
